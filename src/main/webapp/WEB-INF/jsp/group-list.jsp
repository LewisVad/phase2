...
<h1 class="text-center">Groups</h1><br>
<h3 class="text-center">
  <a href="#" onclick='mypopup("/newGroup"); return false;'>
...
<div class="container">
  <table style="width:100%" border="1">
    ...
    <tr>
      <td id="id">${group.id}</td>
      <td id="name">${group.name}</td>
      <td id="action">
          <a href="#" onclick="mypopup('/group/${group.id}'); return false;">
            <button class="btn btn-primary">EDIT</button>
          </a>
            <form action="/deleteGroup/${group.id}" method="post">
            <a href="/deleteGroup/${group.id}">
